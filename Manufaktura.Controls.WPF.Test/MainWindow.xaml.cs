    ...
    public partial class MainWindow : Window
    {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (dialog.ShowDialog().Value)
            {
                ...
                ((MidiTaskScorePlayer)testViewModel.Player).SetInstrument(GeneralMidiInstrument.SteelDrums);
        ...
        private async void LoadTestModel(HookDirectionAlgorithm hookDirectionAlgorithm)
        {
            ...
            (vm.Player as MidiTaskScorePlayer).SetInstrument(GeneralMidiInstrument.SteelDrums);
            var devices = MidiTaskScorePlayer.AvailableDevices;
        }
